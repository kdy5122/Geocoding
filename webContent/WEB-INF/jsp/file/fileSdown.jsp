...
<div id="outter">
 <h2 class = "h21"> 지오코딩 성공파일 다운로드 </h2>
<div style = "text-align: right;">
      <button type = "button" class="btn01" onclick = "location.href='http://localhost:8080/geo/index'">HOME 화면
 	  </button>
 	   <button type = "button" class="btn01" onclick = "javascript:$api.request.file_list('fail')">실패 파일목록 보기
 	  </button>
</div> 
  <tr>
...
<tr>
         ...
         <td style="width:25px;border:3px solid rgb(233,233,233);text-align: center;">
            <div id = "file_down_list">
                 <button type = "button" class="geo-success-down btn01" onclick = "javascript:$api.request.geoCode_file_downLoad(<%=i%>,'success')">다운로드
 	             </button> 
